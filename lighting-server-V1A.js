...
serverCode = serverCode.replace(
  ...
  "const filePath = path.join(__dirname, 'lighting-app-V1A.html');"
);
...
const m = new Module(path.join(__dirname, 'lighting-server-V1A.js'));
m.filename = path.join(__dirname, 'lighting-server-V1A.js');
m.paths = Module._nodeModulePaths(__dirname);
m._compile(serverCode, path.join(__dirname, 'lighting-server-V1A.js'));
